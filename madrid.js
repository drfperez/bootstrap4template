...
function tourism() {
	...
	if (fh < 8) {
		document.getElementById("THP").setAttribute("value", "20€");
	} else if (fh >= 8 && fh <= 11.99) {
		document.getElementById("THP").setAttribute("value", "59€");
	} else if (fh >= 12 && fh <= 15.99) {
		document.getElementById("THP").setAttribute("value", "129€");
	} else if (fh >= 16 && fh <= 19.99) {
		document.getElementById("THP").setAttribute("value", "179€");
	} else if (fh >= 20) {
		document.getElementById("THP").setAttribute("value", "224€");
	}
}
...
function tractor() {
	...
	if (fh < 16) {
		document.getElementById("THP").setAttribute("value", "32€");
	} else if (fh >= 16 && fh <= 25) {
		document.getElementById("THP").setAttribute("value", "50€");
	} else if (fh > 20) {
		document.getElementById("THP").setAttribute("value", "149€");
	}
}
...
function bus() {
	...
	if (seats < 21) {
		document.getElementById("THP").setAttribute("value", "145€");
	} else if (seats >= 21 && seats <= 50) {
		document.getElementById("THP").setAttribute("value", "212€");
	} else if (seats > 50) {
		document.getElementById("THP").setAttribute("value", "266€");
	}
}
...
function truck() {
	...
	if (cargo < 1000) {
		document.getElementById("THP").setAttribute("value", "73€");
	} else if (cargo >= 1000 && cargo <= 2999) {
		document.getElementById("THP").setAttribute("value", "149€");
	} else if (cargo > 2999 && cargo <= 9999) {
		document.getElementById("THP").setAttribute("value", "213€");
	} else if (cargo > 9999) {
		document.getElementById("THP").setAttribute("value", "266€");
	}
}
...
function motorbike() {
	...
	if (cc <= 125) {
		document.getElementById("THP").setAttribute("value", "7€");
	} else if (cc > 125 && cc <= 250) {
		document.getElementById("THP").setAttribute("value", "12€");
	} else if (cc > 250 && cc <= 500) {
		document.getElementById("THP").setAttribute("value", "27€");
	} else if (cc > 500 && cc <= 1000) {
		document.getElementById("THP").setAttribute("value", "60€");
	} else if (cc > 1000) {
		document.getElementById("THP").setAttribute("value", "121€");
	}
}